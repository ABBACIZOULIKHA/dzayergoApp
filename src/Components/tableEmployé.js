  ...
  <div className='flex flex-col'>
     ...
     <div className='flex flex-col mx-10 my-7 text-sm   '>
        ...
        {employés.map((employe)=>(
         <div  className='shadow-xl flex flex-row gap-32  border-2 py-2 mb-1 rounded-full border-lightgris '><div className='ml-4 w-44  flex flex-row gap-4 '> <img  className =' w-10 h-10 rounded-full'src={img3}/><h1>{employe.Nom}{employe.Prenom}</h1> </div>  <div   className='w-40 '>{employe.Email}</div>     <div className='w-20'>{employe.PhoneNumber}</div>     <div className='flex flex-row '> <img className='w-6 h-5 mx-2' src={img1}/><img  className='w-6 h-5'src={img2}/></div> </div>    
        
     ))}  



        {/* <div  className='shadow-xl flex flex-row gap-32  border-2 py-2 mb-1 rounded-full border-lightgris '><div className='ml-4 w-44  flex flex-row gap-4 '> <img  className =' w-10 h-10 rounded-full'src={img3}/><h1>Abbaci Zoulikha</h1> </div>  <div   className='w-40 '> kz_abbaci@esi.dz</div>     <div className='w-20'>0793921328</div>     <div className='flex flex-row '> <img className='w-6 h-5 mx-2' src={img1}/><img  className='w-6 h-5'src={img2}/>   </div> </div>
        <div  className='shadow-xl flex flex-row gap-32  border-2 py-2 mb-1 rounded-full border-lightgris '><div className='ml-4 w-44  flex flex-row gap-4 '> <img  className =' w-10 h-10 rounded-full'src={img3}/><h1>Abbaci Zoulikha</h1> </div>  <div   className='w-40 '> kz_abbaci@esi.dz</div>     <div className='w-20'>0793921328</div>     <div className='flex flex-row '> <img className='w-6 h-5 mx-2' src={img1}/><img  className='w-6 h-5'src={img2}/>   </div> </div>
        <div  className='shadow-xl flex flex-row gap-32  border-2 py-2 mb-1 rounded-full border-lightgris'><div  className='ml-4 w-44  flex flex-row gap-4 ' ><img  className =' w-10 h-10 rounded-full'src={img3}/><h1>Abbaci Zoulikha</h1> </div>  <div   className='w-40 '> kz_abbaci@esi.dz </div>     <div className='w-20'>0793921328</div>    <div className='flex flex-row '> <img className='w-6 h-5 mx-2' src={img1}/><img className='w-6 h-5' src={img2}/>   </div> </div>
        <div  className='shadow-xl flex flex-row gap-32  border-2 py-2 mb-1 rounded-full border-lightgris'><div  className='ml-4 w-44  flex flex-row gap-4' > <img  className =' w-10 h-10 rounded-full'src={img3}/><h1>Abbaci Zoulikha</h1> </div>  <div   className='w-40 '> kz_abbaci@esi.dz </div>     <div className='w-20'>0793921328</div>    <div className='flex flex-row '> <img className='w-6 h-5 mx-2' src={img1}/><img  className='w-6 h-5'src={img2}/>   </div> </div>
        <div  className='shadow-xl flex flex-row gap-32  border-2 py-2 mb-1 rounded-full border-lightgris'><div  className='ml-4 w-44  flex flex-row gap-4' > <img  className =' w-10 h-10 rounded-full'src={img3}/><h1>Abbaci Zoulikha</h1> </div>  <div   className='w-40'  > kz_abbaci@esi.dz</div>     <div className='w-20'>0793921328</div>   <div className='flex flex-row '> <img className='w-6 h-5 mx-2' src={img1}/><img  className='w-6 h-5'src={img2}/>   </div> </div>
